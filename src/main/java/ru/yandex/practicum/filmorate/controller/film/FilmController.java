...
public class FilmController extends AbstractControllerWOParams<Film, FilmService> {
    ...
    public void addLike(@PathVariable @Positive long id,
        ...
        service.addLike(id, userId, rate);
    }
    ...
    public List<Film> searchByDirectorOrTitle(@RequestParam(name = "query") String word,
        ...
        return service.searchByDirectorOrTitle(word, location);
    }
