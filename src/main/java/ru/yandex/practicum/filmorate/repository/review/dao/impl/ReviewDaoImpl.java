...
import ru.yandex.practicum.filmorate.repository.review.dao.ReviewMapper;
import ru.yandex.practicum.filmorate.repository.review.dao.ReviewDao;
...
public class ReviewDaoImpl extends AbstractRepository<Review> implements ReviewDao {
    ...
    protected ReviewDaoImpl(JdbcTemplate jdbcTemplate, ReviewMapper mapper, FeedDaoImpl feedStorage) {
