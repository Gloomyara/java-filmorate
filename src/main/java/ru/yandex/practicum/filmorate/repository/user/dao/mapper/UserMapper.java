package ru.yandex.practicum.filmorate.repository.user.dao.mapper;
...
public class UserMapper implements EntityMapper<User> {
    ...
    public User mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        return User.builder()
                .id(rs.getLong("id"))
                .email(rs.getString(TABLE_FIELDS.get(0)))
                .login(rs.getString(TABLE_FIELDS.get(1)))
                .name(rs.getString(TABLE_FIELDS.get(2)))
                .birthday(rs.getDate(TABLE_FIELDS.get(3)).toLocalDate())
                .build();
    }
}
